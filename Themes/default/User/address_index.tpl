			...
			<div class="user-consigneesInfo mod-block">
                ...
                <div class="mod-blank">
					<div style="display:none;" class="info_message" id="notice_show"></div>
						...
						<form id="form-checkConsignee-user_{$vo.address_id}" style="display:none;" class="form-checkConsignee-user" name="theForm" method="post">
							<table class="usereditinfo">
								...
								<tr>
									...
									<td>
										<input type="text" value="America" id="sign_building_{$k}" class="input-txt" name="sign_building">
									</td>
									<td class="state-txt">
										<span class="require-field">*</span>
								...
								<tr>
									...
									<td colspan="3">
										<input type="text" value="{$vo.mobile}" class="input-full" id="mobile_{$k}" name="tel">
						...
						<div id="Account-shippingInfo_{$vo.address_id}" class="Account-shippingInfo">
							<ul class="clearfix">
								<li>
								<label>
									<span>{$vo.first_name}</span><span class="shippingInfo-1"> {$vo.last_name}</span><br>
									<span>America neai</span><br>
									<span>America, </span><span>neai, </span><span>{$vo.zipcode}</span><br>
									<span>Austria</span><br>
									<span>T: {$vo.mobile}</span><br>
								</label>
									<p>
						...
						<form target="hidden_frame" action="user.php" method="post" name="theForm" onsubmit="return checkConsignee(this)" class="form-checkConsignee-user" style="display: none;" id="form-checkConsignee-user_">
							<table class="usereditinfo">
							<tbody>
							<tr>
								<td class="first-txt">
								...
								<td class="first-txt">
									<input name="first_name" type="text" class="input-txt" id="first_name_3" value="" placeholder="First Name">
								</td>
								<td class="last-name">
									<span class="require-field">*</span><span class="txt-r">Last Name</span>
								</td>
								<td class="last-name">
									<div class="last-txt">
										<input name="last_name" type="text" class="input-txt" id="last_name_3" value="" placeholder="Last Name">
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input name="sign_building" type="text" class="input-txt" id="sign_building_3" value="">
								</td>
								<td class="state-txt">
									<span class="require-field">*</span>
									<span class="txt-r">Zip Code</span>
								...
								<td>
									<input name="zipcode" type="text" class="input-txt" id="zipcode_3" value="">
								</td>
							</tr>
							<tr>
								<td class="address-txt">
								...
								<td colspan="3">
									<input name="address" type="text" class="input-full" value="">
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<input name="tel" type="text" id="mobile_3" class="input-full" value="">
									<p class="phone-notice">Only used if there are delivery issues. Never shared or sold</p>
								</td>
							</tr>
							<tr>
								...
								<td class="user-info-operate" colspan="3">
									<input type="submit" name="submit" class="btn-edit" value="Submit">
